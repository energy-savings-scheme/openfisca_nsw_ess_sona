...
setup(
    ...
    url = "https://github.com/Openfisca-NSW/openfisca_nsw_ess_sona",
    include_package_data = True,  # Will read MANIFEST.in
    data_files = [
        ("share/openfisca/openfisca_nsw_ess_sona", ["CHANGELOG.md", "LICENSE", "README.md"]),
        ],
    install_requires = [
        'OpenFisca_nsw_base'
